...
1. **Current prices** — today’s and tomorrow’s total inkl. moms, as side-by-side 24-hour charts. Each hour is a horizontal line (`00-01` … `23-24`) with the value on the right. Lines are green / orange / red from cheap to expensive. The current hour is marked, and that hour’s price is shown large above the charts.
